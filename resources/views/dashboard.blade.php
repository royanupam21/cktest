            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Welcome Admin!1 to newLegalPanda</h3>
								<p>
									{{Auth::user()}}
								</p>
								<ul class="breadcrumb">
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3>$56485</h3>
										<h6 class="text-muted">Progressions</h6>
										<div class="progress progress-sm">
					...
					<div class="row">
						<div class="col-md-6 d-flex">
							...
							<div class="card card-table flex-fill">
								<div class="card-header">
									<h4 class="card-title">Recent Case</h4>
								</div>
								<div class="card-body">
