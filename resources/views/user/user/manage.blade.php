			...
			<div class="col-sm-12">
				...
				<div class="card card-table">
					<div class="card-header">
						<h4 class="card-title">List of Profile Suggetion</h4>
						...
						<div class="col-md-12" style="overflow-y: visible;">
							<table class="table table-condensed table-bordered table-sm">
								...
								<tbody>
									...
									<tr>
										<td>
										<a class="btn btn-sm btn-success confirmation deleteUsers" href="#" id="deleteUsers_{{$data->id}}"><i class="fa fa-eye"></i> View Profile</a>	
										</td>
										<td>{{$data->fname." ".$data->lname}}</td>
										<td>{{$data->mangalik}}</td>
										<td>@php 
										$meter_val=0;
											$meter_val+=($data->mangalik==Auth::user()->gender)?35:0;
											$meter_val+=($data->occupation==Auth::user()->occupation)?32.5:0;
											$meter_val+=($data->family_type==Auth::user()->family_type)?32.5:0;
											@endphp

											<div class="progress">
											<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="{{$meter_val}}"
											aria-valuemin="0" aria-valuemax="100" style="width:{{$meter_val}}%">
												{{$meter_val}}% Match
											</div>
											</div>
										</td>
